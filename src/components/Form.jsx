...
// // Vite environment variable import
// import { VITE_EMAILJS_SERVICE_ID } from "vite";
          ...
          <Form className="grid md:grid-cols-2 gap-5 md:col-span-2">
            <div>
              <Field
                ...
                className="px-5 py-3 rounded-full outline-none text-slate-900 beautiful-shadow w-full"
              />
            </div>
            <div>
              <Field
                ...
                className={
                  "px-5 py-3 rounded-full outline-none text-slate-900 beautiful-shadow w-full" +
                  " " +
            ...
            <div className="md:col-span-2">
              <Field
                ...
                placeholder="Message"
                className={
                  "px-5 py-3 rounded-xl outline-none text-slate-900 beautiful-shadow w-full" +
                  " " +
